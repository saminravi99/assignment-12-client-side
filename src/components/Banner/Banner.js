    ...
    <div className="d-flex flex-column-reverse flex-lg-row align-items-center justify-content-between container mx-auto">
      <div className="banner-info">
        ...
        <h6>
          ...
          possible way. We have all kinds of power tools, fabricated metal
          products, industrial supplies and other related materials can fulfill
          all your needs.
        </h6>
        <button className="btn btn-success my-2 d-lg-inline d-block mx-lg-0 mx-auto">
          Explore
        </button>
      </div>
